...
class DatasetBase:
    ...
    def generate_pourcent_dataset(self, *data_sources, pourcentage, repeat=True):
        ...
        print("WE ARE DANS LA BONNE FONCTION")
        ...
        for data_source in data_sources:
            ...
            for label, items in tracker.items():
                ...
                borne = int(len(sampled_items) * pourcentage / 100)
                data_interm = sampled_items[:borne]

                dataset.extend(data_interm)
